...
import { FaGithub, FaArrowLeft, FaMoon, FaSun } from 'react-icons/fa';
...
const Navbar = ({ selectedComponent }) => {
  ...
  return (
    <nav className={`bg-gradient-to-r ${theme === 'light' ? 'from-indigo-500 via-gray-500 to-pink-600' : 'from-gray-800 via-black to-gray-600'}`}>
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button onClick={toggleTheme} className="text-white font-bold mr-4 text-4xl">
