        ...
        {error && <p>{error}</p>}
               {quote && (
                ...
                <div className='flex gap-2 mt-4'>
                    ...
                    className='px-4 py-2 rounded bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white font-bold  shadow-lg hover:from-pink-600 hover:via-red-600 hover:to-yellow-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50 transition-all duration-300'>Search by tag</button>
                </div>
            </div>
